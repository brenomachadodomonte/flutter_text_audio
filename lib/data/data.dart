...
List dataAudios = [
  {
    ...
    'audios': [
      {'name': 'Jake','path': 'assets/audios/1/jake.mp3'},
      {'name': 'John','path': 'assets/audios/1/john.mp3'},
      {'name': 'Moira','path': 'assets/audios/1/moira.mp3'},
      {'name': 'Natalie','path': 'assets/audios/1/natalie.mp3'},
    ]
  },
];